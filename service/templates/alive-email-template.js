...
<head>
    ...
    <title>Alive Booking Confirmed</title>
    <style>
...
<body>
    <div class="container">
        <h1>Alive Electric Scooter Booking Confirmed</h1>
        <p>Dear ${aliveOrder.name},</p>
        ...
        <table>
            <tr>
                <th>Booking ID:</th>
                <td>${aliveOrder.reservation_number}</td>
            </tr>
            <tr>
                <th>Name:</th>
                <td>${aliveOrder.name}</td>
            </tr>
            <tr>
                <th>Email:</th>
                <td>${aliveOrder.email}</td>
            </tr>
            <tr>
                <th>Mobile:</th>
                <td>${aliveOrder.mobile}</td>
            </tr>
            <tr>
                <th>Model:</th>
                <td>Alive ${aliveOrder.model}</td>
            </tr>
            <tr>
                <th>Color:</th>
                <td>${aliveOrder.colorName}</td>
            </tr>
            <tr>
                <th>Price:</th>
                <td>₹ ${aliveOrder.price}</td>
            </tr>
            <tr>
                <th>Payment Status:</th>
                <td>${aliveOrder.payment_status}</td>
            </tr>
            <tr>

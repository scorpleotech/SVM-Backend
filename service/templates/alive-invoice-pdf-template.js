...
module.exports = function ALIVE_INVOICE_HTML_TEMPLATE(
  aliveOrder,
  aliveStore,
  aliveCustomer,
  aliveVariant,
        ...
        <div>
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                <div style="display: flex;flex-direction: column; row-gap: 8px;">
                    <p style="margin: 0;line-height: normal;">${aliveOrder.name}</p>
                    <p style="margin: 0;line-height: normal;">${aliveOrder.email}</p>
                    <p style="margin: 0;line-height: normal;">${aliveOrder.mobile}</p>
                ...
                <div style="display: flex;flex-direction: column; row-gap: 8px;">
                    <p style="margin: 0;line-height: normal;">${aliveOrder.reservation_number}</p>
                    <p style="margin: 0;line-height: normal;">${moment(aliveOrder.createdAt).format("DD-MM-YYYY")}</p>
                    <p style="margin: 0;line-height: normal;">${aliveOrder.reservation_number}</p>
                    <p style="margin: 0;line-height: normal;">${moment(aliveOrder.createdAt).format("DD-MM-YYYY")}</p>
            ...
            <table style="margin-top: 30px; width: 100%; border-collapse: collapse;">
                ...
                <tr style="border-bottom: 1px solid #ddd;">
                    <td style="min-height: 40px; padding: 5px 10px; vertical-align: top; font-size: 17px;">
                        Alive ${aliveOrder.model.toUpperCase()} - Electric Scooter
                        <div style="padding-left: 10px; margin: 10px 0 15px; display: flex; flex-direction: column; row-gap: 5px;">
                            <p style="margin: 0;line-height: normal;font-size: 13px;"><b>Color:</b> ${aliveOrder.colorName}</p>
                            <p style="margin: 0;line-height: normal;font-size: 13px;"><b>Hub:</b> ${aliveStore.name || "Srivaru Motors"}</p>
                            <p style="margin: 0;line-height: normal;font-size: 13px;"><b>Vehicle Type:</b> Electric Scooter</p>
                        </div>
                    </td>
                    <td style="min-height: 40px; padding: 5px 10px; vertical-align: top; font-size: 17px;">1</td>
                    <td style="min-height: 40px; padding: 5px 10px; vertical-align: top; font-size: 17px;">₹ ${aliveOrder.price}</td>
                </tr>
